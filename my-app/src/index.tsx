...
import { AllSaleByFranchisePage } from "./pages/allSaleByFranchise/allSaleByFranchisePage";
  ...
  <React.StrictMode>
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/user-franchise/:id" element={<AllUserFranchisePage />} />
        ...
        <Route
          path="/sale/franchise/:id"
          element={<AllSaleByFranchisePage />}
        />
      </Routes>
    </BrowserRouter>
  </React.StrictMode>
