...
export default function UpdateProductForm() {
    ...
    async function HandleDelete() {
        ...
        const deleteDataProduct = await api.deleteProductById(String(deleteProduct))
    }
        ...
        <div>
            <div>
                ...
                <form onSubmit={HandleSubmit}>
                    <div>
                        <label>Nome</label>
                        <input name='nome' value={product?.name} />
                    </div>

                    <div>
                        <label>Descrição</label>
                        <input name='descricao' value={product?.description} />
                    </div>


                    <div>
                        <label>Score</label>
                        <input name='pontuacao' value={product?.score} />
                    </div>
